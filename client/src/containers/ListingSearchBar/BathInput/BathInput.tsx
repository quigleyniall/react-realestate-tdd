        ...
        >
          <div className="p-4">
            ...
            <div className="d-flex">
              ...
              <Button test="two-bath" text="2+" onPress={click('2+')} />
              <Button test="three-bath" text="3+" onPress={click('3+')} />
              <Button test="four-bath" text="4+" onPress={click('4+')} />
              <Button test="five-bath" text="5+" onPress={click('5+')} />
            </div>
          </div>
        </div>
      </div>
